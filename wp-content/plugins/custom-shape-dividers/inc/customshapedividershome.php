...
global $wpdb;
?>
<div class="wrap" id="customshapedivdr">
    ...
    <div class="container-fluid firstsection-mkdivr">
        <div class="row">
            <div class="col-md-3"></div>
            <div class="col-md-6">
                <h1>Custom Shape Dividers</h1>
                <p style="padding:30px;">We created this free tool to make it easier for designers and developers to export a beautiful SVG
                    shape divider for their latest project. We hope you enjoy this tool.
                    <br>
                    <br>
                    Our Shape Dividers are premade SVG shapes that are not dynamic to the settings
                    you use on the toolbar. Every Shape exported will come out as per it's original
                    design and is manipulated via the code you export with it and implement into your web build.</p>
                </div>
            <div class="col-md-3"></div>
        </div>
    </div>

    <div  class="container mx-auto mb-1 px-2 md:sticky top-0 z-40" id="middleshapebuilder">
    ...
    <div class="container preview-container">
        ...
        <div  class="w-full relative" id="mymainshapecont">
            ...
            <div  class="custom-shape-divider" style="top: 0px;"><svg id="mymainsvgelm"
                    data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120"
                    preserveAspectRatio="none" class="" style="width: calc(100% + 1.3px); height: 150px;">
                    <path 
    ...
    <div class="mycustomvariationbk">
        <span class="mycustombk1 active">1</span>
        <span class="mycustombk2">2</span>
        <span class="mycustombk3">3</span>
    </div>

    <div class="container"> 
      <div class="row">
          <div class="col-12 wantoshowonpage">
              <center>I want to show my custom shape divider in my post & pages</center>
              <div class="onoffpostpage">
              <form action="javascript(void(0))" method="post" id="csdexitid">
              <?php wp_nonce_field('mycustomshapedividersave','vfm-nonce'); ?>
<?php 
global $wpdb;
...
?>
                ...
                <p class="onoff "><input type="checkbox" value="1" <?php echo esc_html_e($checkboxvalue); ?> id="checkboxpostpage" name="iwantit"><label for="checkboxpostpage"></label></p>          
              </form>
            </div>
          </div>
      </div>
      <div class="row">
          ...
          <div class="col-showcaseplugins">
              <a href="https://wordpress.org/plugins/v-form/" target="_blank">VForm your Fast & Secure Form Builder for WordPress</a>
              <p>The best WordPress contact form plugin. Easy & Fast online form builder that helps you create beautiful contact forms with just a few clicks.</p>
              <a href="https://wordpress.org/plugins/v-form/" target="_blank">View</a>
          </div>
          <div class="col-showcaseplugins">
              ...
              <p>The best WordPress contact form plugin. Easy & Fast online form builder that helps you create beautiful contact forms with just a few clicks.</p>
              <a href="https://wordpress.org/plugins/exit-popup-advanced/" target="_blank">View</a>
          </div>
